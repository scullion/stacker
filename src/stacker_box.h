...
enum PassFlag {
	PASSFLAG_SIZE_CHILDREN_MAJOR          = 1 << 0,
	PASSFLAG_SIZE_CHILDREN_MINOR          = 1 << 1,
	PASSFLAG_COMPUTE_WIDTH_FROM_PARENT    = 1 << 2,
	PASSFLAG_COMPUTE_HEIGHT_FROM_PARENT   = 1 << 3,
	PASSFLAG_COMPUTE_WIDTH_FROM_CHILDREN  = 1 << 4,
	PASSFLAG_COMPUTE_HEIGHT_FROM_CHILDREN = 1 << 5
};

const unsigned PASSFLAG_SIZE_CHILDREN_MASK = PASSFLAG_SIZE_CHILDREN_MAJOR | PASSFLAG_SIZE_CHILDREN_MINOR;
const unsigned PASSFLAG_FROM_PARENT_MASK        = PASSFLAG_COMPUTE_WIDTH_FROM_PARENT | PASSFLAG_COMPUTE_HEIGHT_FROM_PARENT;
const unsigned PASSFLAG_FROM_CHILDREN_MASK = PASSFLAG_COMPUTE_WIDTH_FROM_CHILDREN | PASSFLAG_COMPUTE_HEIGHT_FROM_CHILDREN;
const unsigned PASSFLAG_ALL                = PASSFLAG_SIZE_CHILDREN_MASK | PASSFLAG_FROM_PARENT_MASK | PASSFLAG_FROM_CHILDREN_MASK;
